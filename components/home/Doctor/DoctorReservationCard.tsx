...
function DoctorReservationCard({}: Props) {
  return (
    <div>
      <div>
        <div
          ...
          className={`relative w-[400px] h-48 rounded-xl overflow-hidden mx-auto`}
        >
          ...
          <div className={style.cardContainer}>
            <div
              className={`${style.eight}  outline-dashed outline-offset-4 outline-[1.5px]`}
            >
              <Image fill alt="sd" className="eight" src={'/2.jpeg'} />
              {/* <div className="absolute inset-0 bg-[#c33c3345]"></div> */}
            </div>
            <div className={`!text-2xl !text-white ${style.title}`}>
              دکتر احمد رضایی
            </div>
            <div className={style.subtitle}>
              ...
              <a
                ...
                href="https://www.facebook.com/bisk8s"
                target="_blank"
              ...
              <a
                className={style.tumblr}
                href="http://glucstudio.tumblr.com/"
                target="_blank"
                rel="noopener noreferrer"
              >
                t
