...
const Footer = () => (
  <div
    className="relative min-h-screen h-[800px]"
    style={{ clipPath: 'polygon(0% 0, 100% 0%, 100% 100%, 0 100%)' }}
  >
    <div className="fixed bottom-0  h-[670px] w-full">
      <section className="headGradient text-black px-8 flex items-center justify-start flex-col paddings w-full gap-20 border-t border-t-primary/30  ">
